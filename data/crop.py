...
def align_img_and_pc(img_dir, pc_dir, calib_dir):
    ...
    pts = load_velodyne_points( os.path.abspath(pc_dir) )
    P, Tr_velo_to_cam, R_cam_to_rect = load_calib( os.path.abspath(calib_dir) )
...
IMG_ROOT = 'data_im/data_object_image_2/training/image_2/'
PC_ROOT = 'data_im/data_object_velodyne/training/velodyne/'
CALIB_ROOT = 'data_im/data_object_calib/training/calib/'
